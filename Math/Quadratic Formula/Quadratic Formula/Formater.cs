...
namespace Quadratic_Formula
{
    class Formater
    {
        public static string AddTheProperSign(int intInQuestion, bool SwitchSign)
        {
            if (SwitchSign == true)
            {
                return Convert.ToString(-1 * intInQuestion);
            }
            else if (intInQuestion <= -1)
            {
        ...
        public static decimal ConvertDec(string value)
        {
            return 0m;
        }
        ...
        public static bool CheckForDecmal(double intInQuestion)
        {
            string intString = Convert.ToString(intInQuestion);
